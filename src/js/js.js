...
const texts = [
    ...
    "مكتب امنون للاستشارات الأمنية يشارك في الندوة الثالثة لأمن وسلامة المنشآت الحيوية بورقتي عمل يقدمها نخبة من المستشاريين الأمنيين ، الندوة المزمع إقامتها  في محافظة ظفار في سلطنة عُمان خلال الفترة من 2-4 سبتمبر",
